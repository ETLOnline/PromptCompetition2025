...
import ViewLevel2LeaderboardTable from "@/components/ViewLevel2Leaderboard"
import { useRouter, useParams } from "next/navigation"
import { fetchWithAuth } from "@/lib/api";

export default function AdminLevel2LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        <ViewLevel2LeaderboardTable competitionId={competitionId} />
      </div>
    </div>
  )
}
